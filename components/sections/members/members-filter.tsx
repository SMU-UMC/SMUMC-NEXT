...
export const MembersFilter = ({
	...
	return (
		<div className="flex flex-col items-center justify-center gap-10 sm:gap-20 mt-8 sm:mt-20 w-[90%] md:w-[80%]">
			<div className="relative w-full">
				<span
					className="absolute inset-0 flex items-center justify-center text-4xl sm:text-6xl md:text-7xl font-black text-center tracking-wide text-zinc-600/15 animate-float select-none pointer-events-none -mt-30 sm:-mt-20 md:-mt-28"
					aria-hidden="true"
				>
					Break The Rules
				</span>
